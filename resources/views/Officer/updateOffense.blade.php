                    ...
                    <form action="{{ route('Officer.updateOffense', $offense->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="driver_id" name="driver_id"
                                value="{{ $offense->driver_id }}" readonly>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="details_offense" name="details_offense"
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('Officer.offenseList') }}" class="btn btn-secondary ms-2">Back to List</a>
                        </div>
                    </form>
